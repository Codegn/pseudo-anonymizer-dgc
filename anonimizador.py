...
los archivos deben estar directamente en la carpeta y no es sub-carpetas."""
...
instrucciones_diccionario = """Seleccione la carpeta donde se encuentra el diccionario 
con las patentes o en su defecto donde desea que se encuentre. Recuerde que el diccionario 
debe llamarse diccionario.txt de lo contrario se creará uno nuevo."""
